        ...
        <div class="layout">
            <div class="layout-topbar clearfix">
                <div class="layout-name" :class="{'sider-mini': isCollapse}">
                    <router-link class="full" to="/" v-if="!isCollapse">Appointment System</router-link>
                    <span class="mini" v-else>AS</span>
                </div>
            ...
            <div v-loading="$root.store.state.loading" class="layout-body"
                 :class="{'sider-full': !isCollapse,'sider-mini': isCollapse}">
                ...
                <div class="layout-panel">
                    ...
                    <div class="layout-footer"> ELLLAB © 2020</div>
                </div>
            </div>
        </div>
    </div>
